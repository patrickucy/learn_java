...
public class CostDAOImpl implements ICostDAO {
	...
	public Cost findByID(int id) throws DAOException {
		...
		try {
			...
			e.printStackTrace();
			throw new DAOException("Fail to fetch data via id you provided", e);
	...
	public void update(Cost cost) throws DAOException {
		...
		try {
			...
			try {
				...
				e1.printStackTrace();
				throw new DAOException("Fail to rollback your update", e);

			}
			throw new DAOException("Fail to update record", e);
		}
