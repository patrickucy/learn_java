...
---增加历史表
create sequence account_seq start with 1021;
----------------------- 表相关的所有语句DDL，DML，TCL
--资费信息表
...
create sequence cost_seq start with 10;
...
alter table ADMIN_INFO add constraint ADMIN_INFO_ID_PK primary key (ID);
...
-- Generate id sequence for role id
...
insert into ROLE (id, name) values (2, '营业员');
insert into ROLE (id, name) values (3, '领导');
