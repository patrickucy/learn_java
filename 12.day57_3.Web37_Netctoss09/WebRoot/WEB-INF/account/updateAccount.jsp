...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="main">  
            ...
            <!-- 避免加了struts内置的样式 -->
            <s:form action="updateAccount.action" method="post" cssClass="main_form" theme="simple">
                    <!--必填项-->
                    ...
                    <div class="input_info">
                    	...
                    	<s:textfield name="account.recommenderIdcardNo" cssClass="readonly" readonly="true"></s:textfield>
