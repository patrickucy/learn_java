        ...
        <div id="main">
            <form action="" method="">
                    ...
                    <table id="datalist">
                        ...
                        <tr>
                            ...
                            <td>                                
                                ...
                                <input type="button" value="修改" class="btn_modify" onclick="location.href='toUpdateCost.action?id=<s:property value="id"/>';" />
                ...
                <div id="pages">
                	...
                	<s:else>
                		<a href="findCost.action?currentPage=<s:property value="currentPage -1"/>">上一页</a>
                	</s:else>
        	       	...
        	       	<s:iterator begin="1" end="totalPages" var="i">
        	       		...
        	       		<s:if test="#i==currentPage">
        	       			<a href="findCost.action?currentPage=<s:property value="#i"/>" class="current_page"> <s:property value="#i"/>  </a>
        	       		</s:if>
        	       		<s:else>        	       		
        	       			<a href="findCost.action?currentPage=<s:property value="#i"/>"> <s:property value="#i"/> </a>
        	       		</s:else>
        	       	</s:iterator>	
                	...
                	<s:else>
                		<a href="findCost.action?currentPage=<s:property value="currentPage +1"/>">下一页</a>
                	</s:else>
                </div>
            </form>
        </div>
