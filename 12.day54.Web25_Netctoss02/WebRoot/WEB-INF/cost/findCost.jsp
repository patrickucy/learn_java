            ...
            <form action="" method="">
                ...
                <div id="pages">
                	...
                	<c:choose>
                		...
                		<c:otherwise>
                			<a href="findCost.action?currentPage=${currentPage-1}">上一页</a>
                		</c:otherwise>
                	</c:choose>
        	       	...
        	       	<c:forEach begin="1" end="${totalPages }" var="i">
        	       		<!-- just like a if else statement -->
        	       		<c:choose>
        	       			<c:when test="${i==currentPage}">
       	        	       	    <a href="findCost.action?currentPage=${i}" class="current_page">${i}</a>
        	       			</c:when>
        	       			<c:otherwise>
        	       				<a href="findCost.action?currentPage=${i}">${i}</a>
        	       			</c:otherwise>
        	       		</c:choose>
                    ...
                    <c:choose>
                		...
                		<c:otherwise>
                			<a href="findCost.action?currentPage=${currentPage+1}">下一页</a>
                		</c:otherwise>
                	</c:choose>
                </div>
            </form>
