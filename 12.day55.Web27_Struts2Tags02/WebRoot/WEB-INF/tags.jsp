...
<html>
  ...
  <body>
    ...
    <h1>*1. observe ValueStack tag</h1>
    <h2> <%-- <s:debug/> --%> </h2>
   	<br/>
   	
   	<h1>*2. acccess context object</h1>
   	<h2> <s:property value="#request.getClass().getName()"/> </h2>
   	<br/>
   	
   	<h1>3. output the top of the stack</h1>
   	<h2><s:property/> </h2>
    <br/>
    
    <h1>4. iterate collection</h1>
    <h2>
