...
//				long when = e.getWhen(); // in this project, we don't need when, here is just a demo of how powerful KeyEvent is
				...
				case KeyEvent.VK_DOWN: softDropAction();
				break;
				...
				break;
				case KeyEvent.VK_UP: rotateClockwiseAction();
				break;
				case KeyEvent.VK_R: rotateAntiClockwiseAction();
				break;
				case KeyEvent.VK_P: pauseAction();;
				break;
...
//		frame.setUndecorated(true); // get rid of window frame
		...
		tetris.setBackground(new Color(Color.yellow.hashCode())); // (0xffff00)in my point of view hashCode() is just the ID
		frame.add(tetris); // add Tetris(JPanel to current window
