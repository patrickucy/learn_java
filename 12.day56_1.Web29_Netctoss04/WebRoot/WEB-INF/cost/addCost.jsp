    ...
    <head>
        ...
        <script language="javascript" type="text/javascript">
        	...
        	function checkName() {
				...
				// 判断资费名称是否重复
				$.post("checkCostName.action",{"name":costName},function (data){
					// data is the data from our server side, a json string, namely isExist
					var isExist = data;
					if(isExist){
        ...
        <div id="main">            
            ...
            <form action="addCost.action" method="post" class="main_form">
                ...
                <div class="input_info">
                    <input type="text" class="width300" id="costName" name="cost.name" value="" onblur="checkName();"/>
