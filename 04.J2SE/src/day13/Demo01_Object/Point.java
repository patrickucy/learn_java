...
public class Point {
	...
	public boolean equals(Object obj) {
		...
		/**
		 *  if you are overriding  an equal method, you first need to know if this "obj" is the 
	 ...
	 * for you automatically. you would have to write it by yourself. 
	 * 	
	 * public boolean equals(Object obj) {
			return this == obj;
		}
		...
		However, Java API has overridden all their "equals", don't worry about it
