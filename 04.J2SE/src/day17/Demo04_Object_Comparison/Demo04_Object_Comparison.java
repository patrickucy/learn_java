package day17.Demo04_Object_Comparison;
/**
 * define a comparable class Point
 * @author patrickyu
 *
 */
public class Demo04_Object_Comparison {

	public static void main(String[] args) {
		
	}
	
	class Point implements Comparable<Point> { // give it a generic type, then it can know who to compare
		private int x;
		private int y;
