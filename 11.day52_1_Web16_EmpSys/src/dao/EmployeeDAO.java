...
public class EmployeeDAO {
	...
	public List<Employee> findByPages(int page, int rowsPerPage) throws Exception{
		...
		try {
			...
			stat = conn.prepareStatement("select * from t_emp limit ?,?"); // by page
	...
	public int getTotalPages(int rowsPerPage) throws Exception{
		...
		try {
			conn = DBUtil.getConnection();
			stat = conn.prepareStatement("select count(*) from t_emp");
			rst = stat.executeQuery();
			if(rst.next()){
