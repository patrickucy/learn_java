...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" language="javascript">
        	function change(imgObj) {
				imgObj.src = "createImage.action?date="+ new Date().getTime();
			}
    ...
    <body class="index">
        <div class="login_box">
        	<!-- method="post" you will not encounter a messy code issue  -->
        	<form action="login.action" method="post">
	            ...
	            <table>
	                ...
	                <tr>
	                    ...
	                    <td><img src="createImage.action" onclick="change(this);" alt="验证码" title="点击更换" /></td>  
